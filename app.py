...
PORTFOLIO_ITEMS = [
    {
        'id': 1,
        'title': 'Room Occupancy Detection (B.Tech Minor Project)',
        'description': 'Room occupancy detection using sensor inputs and machine learning to detect presence and activity.',
        'image': 'project1.jpg',
        'technologies': ['Python', 'Scikit-learn', 'Pandas', 'NumPy', 'Sensor Processing'],
        'category': 'ml',
        'type': 'Research / ML Project'
    },
    {
        'id': 2,
        'title': 'Web Development Projects',
        'description': 'Various web-development projects completed during coursework and internships (HTML, CSS, JavaScript, Flask).',
        'image': 'project2.jpg',
    ...
    {
        'id': 3,
        'title': 'Blog App (Tkinter GUI)',
        'description': 'Desktop blog application with a Tkinter GUI. Supports simple CRUD for posts and local JSON storage for persistence.',
        'image': 'project_blog.jpg',
        'technologies': ['Python', 'Tkinter', 'JSON'],
        'category': 'python',
        'type': 'Desktop Application',
        'repo': 'https://github.com/kasumalasowmya/Tkinter-Project'
    },
    {
        'id': 4,
        'title': 'E-Commerce Website (Flask)',
        'description': 'E-commerce website built with Flask - features product listing, cart, and payment integration.',
        'image': 'project_ecom.jpg',
        'technologies': ['Python', 'Flask', 'HTML', 'CSS', 'JavaScript', 'Stripe'],
        'category': 'web',
        'type': 'Web Application',
        'repo': 'https://github.com/kasumalasowmya/Ecom-Web'
    }
]

SITE_OWNER = 'SOWMYA KASUMALA'

SKILLS = {
    'Technical': ['Core Java', 'C fundamentals', 'Python', 'Web Development', 'Machine Learning'],
    'Soft Skills': ['Communication', 'Problem Solving', 'Teamwork', 'Leadership'],
    'Tools & Libraries': ['Git', 'Pandas', 'NumPy', 'Scikit-learn'],
    'Interests': ['Continuous learning', 'Dancing']
}
